"""Create the unified profile-asset schema; WIP data is not migrated."""
...
def upgrade() -> None:
    """Create the static schema independently of live ORM definitions."""
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["asset_id"],
            ["TradingAsset.id"],
            name=op.f("fk_StrategyCapital_asset_id_TradingAsset"),
        ),
        sa.ForeignKeyConstraint(
            ["strategy_id"],
            ["TradingStrategy.id"],
    ...
    op.create_table(
        ...
        sa.Column("exec_symbol", sa.String(length=65), nullable=False),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["asset_id"],
            ["TradingAsset.id"],
            name=op.f("fk_WalletOperation_asset_id_TradingAsset"),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["asset_id"],
            ["TradingAsset.id"],
            name=op.f("fk_TradeReservation_asset_id_TradingAsset"),
        ),
        sa.ForeignKeyConstraint(
            ["trade_snapshot_id"],
            ["TradeSnapshot.id"],
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        "reservation_wallet_snapshot_idx", table_name="TradeReservation"
    )
    op.drop_index(
        "reservation_snapshot_purpose_idx", table_name="TradeReservation"
    )
    ...
    op.drop_index(
        "profile_instrument_symbol_idx", table_name="TradingInstrument"
    )
    op.drop_table("TradingInstrument")
    op.drop_index(
        "strategy_capital_strategy_wallet_asset_idx",
        table_name="StrategyCapital",
    )
    op.drop_table("StrategyCapital")
    op.drop_table("TradingStrategy")
    op.drop_index("profile_asset_symbol_idx", table_name="TradingAsset")
